...
class Client_contr extends Controller
{
    ...
    public function dashboard()
    {
        ...
        $recentQuotes = Devis::with(['client', 'companyinfo', 'devis_items'])
            ...
            ->map(function ($quote) {
                ...
                $isAccepted = Invoice::where('fromdevis', 1)
    ...
    public function devisAccept($id)
    {
        ...
        return redirect()->route('client.invoices.index')->with('success', 'Le devis a été accepté et converti en facture avec succès. Délai maximal pour payer votre facture: 30 jours');
    }
